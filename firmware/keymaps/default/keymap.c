...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = 
{
    ...
    (
        ...
        KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_INS,  KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_PSCR, KC_SCRL, KC_PAUS, KC_NO  ,
        KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  ,          KC_NO  , 
        KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  ,          KC_NO  , KC_VOLU,
        KC_NO  , KC_NO  , KC_NO  ,                   KC_NO  ,                            KC_NO  ,          KC_NO  , KC_MUTE, KC_VOLD, KC_NO  
    )
};
